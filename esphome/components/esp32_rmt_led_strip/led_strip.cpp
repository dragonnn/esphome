...
void ESP32RMTLEDStripLightOutput::setup() {
  ...
  this->rmt_buf_ = rmt_allocator.allocate(
      buffer_size * 8); // 8 bits per byte, 1 rmt_item32_t per bit
...
void ESP32RMTLEDStripLightOutput::set_led_params(uint32_t bit0_high,
                                                 uint32_t bit0_low,
                                                 uint32_t bit1_high,
                                                 uint32_t bit1_low) {
...
light::ESPColorView
ESP32RMTLEDStripLightOutput::get_view_internal(int32_t index) const {
  int32_t r = 0, g = 0, b = 0;
...
float ESP32RMTLEDStripLightOutput::get_setup_priority() const {
